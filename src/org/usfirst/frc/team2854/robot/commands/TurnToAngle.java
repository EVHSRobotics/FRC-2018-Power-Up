...
public class TurnToAngle extends Command {
   ...
   * @param target The target angle in degrees relative to current angle, Ex. To turn by 90 degrees
   *     pass in 90
   * @param maxSpeed the maximum turn speed, will turn at this speed if the angle difference is
   *     greater than 90
  ...
  public TurnToAngle(
    ...
    this(
        drive,
        target,
        (value) -> (Math.min(value, 90)) / 90d * (maxSpeed - minSpeed) + minSpeed,
        threshHoldAngle,
        gyro);
  }
